...
export const GEMINI_ANALYSIS_MODEL = 'gemini-2.5-flash-preview-04-17'; // Usado para resumo, insights, SWOT, comparação e revisão do mestre
...
// CDC_PDF_URL removido
export const CF88_PDF_URL = "CF88_EC134_livro.pdf"; // Mantido para o modo CF88 (chat RAG com PDF)
export const CF88_JSON_URL = "/cf88/cf88_structured.json";
export const CPP_JSON_URL = "/cpp7/cpp7_structured.json"; 
export const CP_JSON_URL = "/cp8/cp8_structured.json";
export const CDC_JSON_URL = "/cdc2013/cdc2013_structured.json";
...
// SYSTEM_INSTRUCTION_CDC removido
...
export const RAG_PREAMBLE = (ragDataString: string): string => `Você tem acesso aos seguintes documentos enviados pelo usuário (ou ao conteúdo da Constituição Federal). Alguns documentos podem incluir um resumo, insights e uma análise SWOT previamente gerados. Use todo o conteúdo disponível (texto original e análises) como base principal para suas respostas.
...
// Simplified - Master Agent will handle detailed formatting and persona
...
export const LOGO_URL = "https://raw.githubusercontent.com/MarceloClaro/AUXJURIS/refs/heads/main/jus.png";
